...
public class FragmentBill extends Fragment implements ObjectUtil {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new BillAdapter(billList, getContext(), this);
    ...
    private void getListBill() {
        ...
        BaseApi.API.getListBill(token,storeId ).enqueue(new Callback<OrderResponse>() {
            @Override
    ...
    } /// nó đang lỗi cái _id j í, đây xem nhá
}